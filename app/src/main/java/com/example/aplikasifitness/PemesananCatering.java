...
public class PemesananCatering extends AppCompatActivity {
    int quantity = 0;
    Button Web, Tlp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pemesanan_catering);
        Web = (Button) findViewById(R.id.button1);
        Web.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(PemesananCatering.this, ActivityWeb.class);
                startActivity(i);
            }
        });
        ...
        Tlp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(PemesananCatering.this, ActivityTelpon.class);
                startActivity(i);
            }
        });
    }
