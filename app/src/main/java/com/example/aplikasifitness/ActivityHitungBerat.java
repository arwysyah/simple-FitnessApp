package com.example.aplikasifitness;
...
public class ActivityHitungBerat extends AppCompatActivity {
    ...
    public void cekHasil(View view) {
        ...
        if(edtNama.getText().toString().equals("")||edtBB.getText().toString().equals("")||edtTB.getText().toString().equals("")){
            ...
            Intent intent = new Intent(ActivityHitungBerat.this,ActivityHasil.class);
            ...
            Log.d("tag","Nama = "+nama+"\nbmi = "+bmi+"");
            if (bmi<18.5){
                //Log.d("keterangan Pria", "Under Weight/Kurus – Sebaiknya mulai menambah berat badan dan mengkonsumsi makanan berkarbohidrat di imbangi dengan olah raga");
                ...
                //Log.d("keterangan Pria","Normal Weight/Normal – Bagus, berat badan anda termasuk kategori ideal");
                hasil="Normal Weight/Normal";
                ket = "Bagus, berat badan anda termasuk kategori ideal";

            }
            else if (bmi>=25&&bmi<30){
                //Log.d("keterangan Pria","Over Weight/Kegemukan – anda sudah masuk kategori gemuk. sebaiknya hindari makanan berlemak dan mulailah meningkatkan olahraga seminggu minimal 2 kali");
                ...
                //Log.d("keterangan Pria","\tObesitas – Sebaiknya segera membuat program menurunkan berat badan karena anda termasuk kategori obesitas/ terlalu gemuk dan tidak baik bagi kesehatan");
                hasil="Obesitas";
